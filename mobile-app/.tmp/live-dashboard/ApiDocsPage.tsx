  ...
  const content = (
    <div className="min-h-screen bg-white dark:bg-neutral-950 transition-colors">
      <div className="flex relative">
        <aside className="hidden lg:block w-56 flex-shrink-0 fixed top-16 left-0 h-[calc(100vh-4rem)] border-r border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900 overflow-y-auto z-40">
